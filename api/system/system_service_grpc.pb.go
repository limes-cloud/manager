...
const (
	System_GetSystemSetting_FullMethodName = "/manager.api.system.System/GetSystemSetting"
)
...
var System_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "manager.api.system.System",
	...
	Metadata: "api/system/proto/system_service.proto",
}
