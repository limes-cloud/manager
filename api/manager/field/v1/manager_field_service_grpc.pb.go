...
const (
	Field_ListFieldType_FullMethodName = "/manager.api.manager.field.v1.Field/ListFieldType"
	Field_ListField_FullMethodName     = "/manager.api.manager.field.v1.Field/ListField"
	Field_CreateField_FullMethodName   = "/manager.api.manager.field.v1.Field/CreateField"
	Field_UpdateField_FullMethodName   = "/manager.api.manager.field.v1.Field/UpdateField"
	Field_DeleteField_FullMethodName   = "/manager.api.manager.field.v1.Field/DeleteField"
)
...
var Field_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "manager.api.manager.field.v1.Field",
	...
	Metadata: "api/manager/field/manager_field_service.proto",
}
