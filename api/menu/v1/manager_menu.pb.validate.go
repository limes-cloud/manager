...
func (m *Menu) validate(all bool) error {
	...
	// no validation rules for CheckObject
	...
	if m.CheckObjectRule != nil {
		// no validation rules for CheckObjectRule
	}
...
// Validate checks the field values on AddMenuReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on AddMenuReply with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in AddMenuReplyMultiError, or
// nil if none found.
func (m *AddMenuReply) ValidateAll() error {
	return m.validate(true)
}

func (m *AddMenuReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AddMenuReplyMultiError(errors)
	}

	return nil
}

// AddMenuReplyMultiError is an error wrapping multiple validation errors
// returned by AddMenuReply.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m AddMenuReplyMultiError) AllErrors() []error { return m }

// AddMenuReplyValidationError is the validation error returned by
// AddMenuReply.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AddMenuReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddMenuReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddMenuReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddMenuReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddMenuReplyValidationError) ErrorName() string { return "AddMenuReplyValidationError" }

// Error satisfies the builtin error interface
func (e AddMenuReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = AddMenuReplyValidationError{}
