...
// Validate checks the field values on ListCurrentMenuRequest with the rules
...
// ValidateAll checks the field values on ListCurrentMenuRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListCurrentMenuRequestMultiError, or nil if none found.
func (m *ListCurrentMenuRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *ListCurrentMenuRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ListCurrentMenuRequestMultiError(errors)
	}

	return nil
}

// ListCurrentMenuRequestMultiError is an error wrapping multiple validation
// errors returned by ListCurrentMenuRequest.ValidateAll() if the designated
...
func (m ListCurrentMenuRequestMultiError) AllErrors() []error { return m }

// ListCurrentMenuRequestValidationError is the validation error returned by
// ListCurrentMenuRequest.Validate if the designated constraints aren't met.
...
func (e ListCurrentMenuRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListCurrentMenuRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListCurrentMenuRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListCurrentMenuRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListCurrentMenuRequestValidationError) ErrorName() string {
	return "ListCurrentMenuRequestValidationError"
}
...
func (e ListCurrentMenuRequestValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sListCurrentMenuRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListCurrentMenuRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListCurrentMenuRequestValidationError{}
