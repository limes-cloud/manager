...
// Validate checks the field values on UpdateUserBasicRequest with the rules
// defined in the proto definition for this message. If any rules are
...
// ValidateAll checks the field values on UpdateUserBasicRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateUserBasicRequestMultiError, or nil if none found.
func (m *UpdateUserBasicRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateUserBasicRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetNickname()) < 1 {
		err := UpdateUserBasicRequestValidationError{
			field:  "Nickname",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	if _, ok := _UpdateUserBasicRequest_Gender_InLookup[m.GetGender()]; !ok {
		err := UpdateUserBasicRequestValidationError{
			field:  "Gender",
			reason: "value must be in list [M F U]",
		}
	...
	if len(errors) > 0 {
		return UpdateUserBasicRequestMultiError(errors)
	}

	return nil
}

// UpdateUserBasicRequestMultiError is an error wrapping multiple validation
// errors returned by UpdateUserBasicRequest.ValidateAll() if the designated
...
// AllErrors returns a list of validation violation errors.
func (m UpdateUserBasicRequestMultiError) AllErrors() []error { return m }

// UpdateUserBasicRequestValidationError is the validation error returned by
// UpdateUserBasicRequest.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e UpdateUserBasicRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateUserBasicRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateUserBasicRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateUserBasicRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateUserBasicRequestValidationError) ErrorName() string {
	return "UpdateUserBasicRequestValidationError"
}
...
func (e UpdateUserBasicRequestValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sUpdateUserBasicRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateUserBasicRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateUserBasicRequestValidationError{}

var _UpdateUserBasicRequest_Gender_InLookup = map[string]struct{}{
	"M": {},
	"F": {},
	"U": {},
}
