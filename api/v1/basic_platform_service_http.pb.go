...
const OperationServiceAddDepartment = "/basic_platform.Service/AddDepartment"
const OperationServiceAddMenu = "/basic_platform.Service/AddMenu"
const OperationServiceAddRole = "/basic_platform.Service/AddRole"
const OperationServiceAddUser = "/basic_platform.Service/AddUser"
const OperationServiceAuth = "/basic_platform.Service/Auth"
const OperationServiceChangeUserPassword = "/basic_platform.Service/ChangeUserPassword"
const OperationServiceChangeUserPasswordCaptcha = "/basic_platform.Service/ChangeUserPasswordCaptcha"
const OperationServiceCurrentRoleMenuTree = "/basic_platform.Service/CurrentRoleMenuTree"
const OperationServiceCurrentUser = "/basic_platform.Service/CurrentUser"
const OperationServiceCurrentUserRoles = "/basic_platform.Service/CurrentUserRoles"
const OperationServiceDeleteDepartment = "/basic_platform.Service/DeleteDepartment"
const OperationServiceDeleteMenu = "/basic_platform.Service/DeleteMenu"
const OperationServiceDeleteRole = "/basic_platform.Service/DeleteRole"
const OperationServiceDeleteUser = "/basic_platform.Service/DeleteUser"
const OperationServiceDisableUser = "/basic_platform.Service/DisableUser"
const OperationServiceEnableUser = "/basic_platform.Service/EnableUser"
const OperationServiceGetDepartmentTree = "/basic_platform.Service/GetDepartmentTree"
const OperationServiceGetMenuTree = "/basic_platform.Service/GetMenuTree"
const OperationServiceGetRoleMenuIds = "/basic_platform.Service/GetRoleMenuIds"
const OperationServiceGetRoleTree = "/basic_platform.Service/GetRoleTree"
const OperationServiceGetUserRoles = "/basic_platform.Service/GetUserRoles"
const OperationServiceLogin = "/basic_platform.Service/Login"
const OperationServiceLoginCaptcha = "/basic_platform.Service/LoginCaptcha"
const OperationServiceLogout = "/basic_platform.Service/Logout"
const OperationServiceOfflineUser = "/basic_platform.Service/OfflineUser"
const OperationServicePageUser = "/basic_platform.Service/PageUser"
const OperationServiceParseToken = "/basic_platform.Service/ParseToken"
const OperationServiceRefreshToken = "/basic_platform.Service/RefreshToken"
const OperationServiceResetUserPassword = "/basic_platform.Service/ResetUserPassword"
const OperationServiceSwitchCurrentUserRole = "/basic_platform.Service/SwitchCurrentUserRole"
const OperationServiceUpdateDepartment = "/basic_platform.Service/UpdateDepartment"
const OperationServiceUpdateMenu = "/basic_platform.Service/UpdateMenu"
const OperationServiceUpdateRole = "/basic_platform.Service/UpdateRole"
const OperationServiceUpdateRoleMenus = "/basic_platform.Service/UpdateRoleMenus"
const OperationServiceUpdateUser = "/basic_platform.Service/UpdateUser"
...
func RegisterServiceHTTPServer(s *http.Server, srv ServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/basic/v1/role/menu/tree", _Service_CurrentRoleMenuTree0_HTTP_Handler(srv))
	r.GET("/basic/v1/role/menu/ids", _Service_GetRoleMenuIds0_HTTP_Handler(srv))
	r.PUT("/basic/v1/role/menu", _Service_UpdateRoleMenus0_HTTP_Handler(srv))
	r.GET("/basic/v1/role/tree", _Service_GetRoleTree0_HTTP_Handler(srv))
	r.POST("/basic/v1/role", _Service_AddRole0_HTTP_Handler(srv))
	r.PUT("/basic/v1/role", _Service_UpdateRole0_HTTP_Handler(srv))
	r.DELETE("/basic/v1/role", _Service_DeleteRole0_HTTP_Handler(srv))
	r.GET("/basic/v1/menu/tree", _Service_GetMenuTree0_HTTP_Handler(srv))
	r.POST("/basic/v1/menu", _Service_AddMenu0_HTTP_Handler(srv))
	r.PUT("/basic/v1/menu", _Service_UpdateMenu0_HTTP_Handler(srv))
	r.DELETE("/basic/v1/menu", _Service_DeleteMenu0_HTTP_Handler(srv))
	r.GET("/basic/v1/department/tree", _Service_GetDepartmentTree0_HTTP_Handler(srv))
	r.POST("/basic/v1/department", _Service_AddDepartment0_HTTP_Handler(srv))
	r.PUT("/basic/v1/department", _Service_UpdateDepartment0_HTTP_Handler(srv))
	r.DELETE("/basic/v1/department", _Service_DeleteDepartment0_HTTP_Handler(srv))
	r.GET("/basic/v1/user/current", _Service_CurrentUser0_HTTP_Handler(srv))
	r.GET("/basic/v1/users", _Service_PageUser0_HTTP_Handler(srv))
	r.POST("/basic/v1/user", _Service_AddUser0_HTTP_Handler(srv))
	r.POST("/basic/v1/user/password/captcha", _Service_ChangeUserPasswordCaptcha0_HTTP_Handler(srv))
	r.POST("/basic/v1/user/password/reset", _Service_ResetUserPassword0_HTTP_Handler(srv))
	r.POST("/basic/v1/user/password/change", _Service_ChangeUserPassword0_HTTP_Handler(srv))
	r.POST("/basic/v1/user/disable", _Service_DisableUser0_HTTP_Handler(srv))
	r.POST("/basic/v1/user/enable", _Service_EnableUser0_HTTP_Handler(srv))
	r.POST("/basic/v1/user/offline", _Service_OfflineUser0_HTTP_Handler(srv))
	r.PUT("/basic/v1/user", _Service_UpdateUser0_HTTP_Handler(srv))
	r.DELETE("/basic/v1/user", _Service_DeleteUser0_HTTP_Handler(srv))
	r.GET("/basic/v1/user/current/roles", _Service_CurrentUserRoles0_HTTP_Handler(srv))
	r.POST("/basic/v1/user/role/switch", _Service_SwitchCurrentUserRole0_HTTP_Handler(srv))
	r.GET("/basic/v1/user/roles", _Service_GetUserRoles0_HTTP_Handler(srv))
	r.POST("/basic/v1/auth", _Service_Auth0_HTTP_Handler(srv))
	r.POST("/basic/v1/login", _Service_Login0_HTTP_Handler(srv))
	r.POST("/basic/v1/login/captcha", _Service_LoginCaptcha0_HTTP_Handler(srv))
	r.POST("/basic/v1/logout", _Service_Logout0_HTTP_Handler(srv))
	r.POST("/basic/v1/token/parse", _Service_ParseToken0_HTTP_Handler(srv))
	r.POST("/basic/v1/token/refresh", _Service_RefreshToken0_HTTP_Handler(srv))
}
...
func (c *ServiceHTTPClientImpl) ChangeUserPassword(ctx context.Context, in *ChangeUserPasswordRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	var out emptypb.Empty
	pattern := "/basic/v1/user/password/change"
...
func (c *ServiceHTTPClientImpl) ChangeUserPasswordCaptcha(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*ChangeUserPasswordCaptchaReply, error) {
	...
	pattern := "/basic/v1/user/password/captcha"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ServiceHTTPClientImpl) CurrentRoleMenuTree(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*CurrentRoleMenuTreeReply, error) {
	...
	pattern := "/basic/v1/role/menu/tree"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ServiceHTTPClientImpl) CurrentUserRoles(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*GetUserRolesReply, error) {
	...
	pattern := "/basic/v1/user/current/roles"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ServiceHTTPClientImpl) GetDepartmentTree(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*GetDepartmentTreeReply, error) {
	...
	pattern := "/basic/v1/department/tree"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ServiceHTTPClientImpl) GetRoleMenuIds(ctx context.Context, in *GetRoleMenuIdsRequest, opts ...http.CallOption) (*GetRoleMenuIdsReply, error) {
	...
	pattern := "/basic/v1/role/menu/ids"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ServiceHTTPClientImpl) LoginCaptcha(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*LoginCaptchaReply, error) {
	...
	pattern := "/basic/v1/login/captcha"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ServiceHTTPClientImpl) RefreshToken(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*RefreshTokenReply, error) {
	...
	pattern := "/basic/v1/token/refresh"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ServiceHTTPClientImpl) ResetUserPassword(ctx context.Context, in *ResetUserPasswordRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	var out emptypb.Empty
	pattern := "/basic/v1/user/password/reset"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *ServiceHTTPClientImpl) SwitchCurrentUserRole(ctx context.Context, in *SwitchCurrentUserRoleRequest, opts ...http.CallOption) (*SwitchCurrentUserRoleReply, error) {
	...
	pattern := "/basic/v1/user/role/switch"
	path := binding.EncodeURL(pattern, in, false)
